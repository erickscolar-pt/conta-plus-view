...
export default function HeaderAviso() {
  ...
  return (
    <header className="sticky top-2 z-40 mx-2 mt-2 rounded-2xl border border-white/10 bg-slate-900/90 p-2.5 text-white shadow-xl shadow-black/25 backdrop-blur-xl sm:top-3 sm:mx-4 sm:mt-3 sm:p-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-lg text-slate-200 transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/70 md:hidden"
