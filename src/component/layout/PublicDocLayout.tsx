...
export default function PublicDocLayout({ title, children }: PublicDocLayoutProps) {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-950 text-slate-100">
      ...
      <HeaderAviso />
      <main className="relative z-10 mx-auto max-w-5xl px-3 py-6 pb-28 sm:px-6 sm:py-10 sm:pb-12">
        ...
        <section className="rounded-2xl border border-white/10 bg-slate-900/70 p-4 shadow-2xl shadow-black/30 backdrop-blur-md transition-colors duration-300 sm:p-8">
          {children}
        </section>
      </main>
    </div>
