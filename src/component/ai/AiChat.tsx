    ...
    <div className="flex h-full min-h-[280px] flex-col sm:min-h-[380px]">
      <div className="border-b border-white/[0.08] pb-3">
        ...
        <p className="text-xs text-cp-subtle">
          Registre, atualize, divida contas com parceiros vinculados ou marque saídas como pagas.
        </p>
      </div>
      <div className="flex-1 space-y-3 overflow-y-auto py-4">
        ...
        {messages.length === 0 && !disabled && (
          <p className="text-sm text-cp-subtle">
            Ex.: &quot;Divide R$ 200 de jantar com a Maria&quot;, &quot;Marca a luz como paga&quot; ou &quot;Registra saída de mercado R$ 150&quot;
          </p>
        )}
        {messages.map((msg, i) => (
          <div
