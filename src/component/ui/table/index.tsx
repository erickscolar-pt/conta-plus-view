                    ...
                    <>
                        <tr key={index}  >
                            {columns.map((column, columnIndex) => (
                                <td key={String(column.key)} className={styles.dataCell} style={{ background: column.render ? '' : color || '#FFF', boxShadow: column.render ? 'none' : '0px 4px 4px 0px rgba(0, 0, 0, 0.25)' }}>
                                    {column.render ? ( 
