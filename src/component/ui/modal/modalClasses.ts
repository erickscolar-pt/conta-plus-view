/** Classes Tailwind reutilizadas nos formulários dentro de modais (tema escuro). */
export const modalScrollArea =
  "max-h-[min(85vh,640px)] overflow-y-auto overscroll-contain";

export const modalTitle = "text-lg font-semibold tracking-tight text-slate-50";
