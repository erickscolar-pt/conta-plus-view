        ...
        <>
                ...
                <div className={styles.objetivosComponent}>
                    ...
                    <div className={styles.objetivos}>
                        ...
                        <div className={styles.footercreate}>
                            ...
                            <ButtonPages bg="#0E1557" onClick={() => setIsModalCreate(true)}>Criar Objetivo</ButtonPages>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <Modal isOpen={isModalEdit} onClose={handleCloseEdit}>
                <div className={styles.containerModal}>
                    ...
                    <ButtonPages bg="#0E1557" loading={loading} onClick={() => saveEdit(modalObjetivos?.id)}>Salvar</ButtonPages>
                </div>
            </Modal>
            ...
            <Modal isOpen={isModalCreate} onClose={handleCloseCreate}>
                <div className={styles.containerModal}>
                    ...
                    <label>
                        <span>Recebido de:</span>
                        <input onChange={(e) => { setCreateNomeObjetivo(e.target.value) }} type="text" value={createNomeObjetivo} />
                    </label>
                    <label>
                        <span>Valor:</span>
